...
public class SadhviFragment extends Fragment {
    ListView sadhulist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((Navigation_Drawer_Activity) getActivity()).type = 2;
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.navigation_menu_sadhvi);
...
//        new VUBaseAsyncTask(getActivity(), null, true, Constant.HOST + Constant.Get_All_Users + "sadhvi", VUBaseAsyncTask.METHOD_GET,
...
//
//                            try {
                        sadhulist.setAdapter(new JSONArrayAdapter(getActivity(), result.getJSONArray("user_array"), R.layout.custom_list, new String[]{"username_hindi"}, new int[]{R.id.name}) {
