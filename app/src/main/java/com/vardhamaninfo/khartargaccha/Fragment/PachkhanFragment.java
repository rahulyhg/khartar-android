...
public class PachkhanFragment extends Fragment {
    ListView stavansang;
    String s_id;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pachkhan, container, false);
        stavansang = (ListView) view.findViewById(R.id.pachakhan);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.navigation_menu_panchakhan);
        getstavansangrah();
        return view;
    }
        ...
        new HttpServerBackend(Application.getAppInstance()).getData(call, new HttpServerBackend.ResponseListener() {
            ...
            public void onReturn(boolean success, Response<JsonObject> data) {
                ...
                if (success) {
                    ...
                    Log.e("  Response getstavansangrah ", data.body().toString() + " response");
                    try {

                        JSONObject result = new JSONObject(data.body().toString());


//        new VUBaseAsyncTask(getActivity(), null, true, Constant.HOST + Constant.S_sangrah + "Pachakhan", VUBaseAsyncTask.METHOD_GET,
//
...
//                            try {
                                ...
                                stavansang.setAdapter(new JSONArrayAdapter(getActivity(), result.getJSONArray("user_array"), R.layout.custom_list, new String[]{"title"}, new int[]{R.id.name}) {
